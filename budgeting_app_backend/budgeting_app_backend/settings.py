"""
Django settings for budgeting_app_backend project.
...
SECRET_KEY = 'django-insecure-)h+erj^+d1-xcwn^nc736b0cs(3qcn70bon+#f$@#q3h-+au*y'
...
ALLOWED_HOSTS = ['https://git.heroku.com/budgetbuddy-application.git', 'localhost', '127.0.0.1']
